...
/*   Updated: 2024/11/25 18:01:00 by mde-beer       ########   odam.nl        */
/*                                                                            */
/* ************************************************************************** */
...
)
{
	...
	const int	rcost = ft_ternary(rt > rp, rt, rp) - ft_abs(rt - rp);
	t_o_ret		ret;
...
)
{
	...
	candidate.oracle = oracle(top, top - a->size, place, place - b->size)l
	return (candidate);
}
